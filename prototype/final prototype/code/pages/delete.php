...
<html>
	...
	<body class="home">
	    <div class="container2">
			...
			?>	        	
	        	<h3>Wil je toch een nieuwe lening aanvragen?</h3>
	        	<form action="questions-loan.php">
	        		<button type="submit" name="submit" class="btn centerbtn deletebtn add btn-primary">Start opnieuw</button>
	        	</form>
	        </div>
